...
export default class StoryScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      story_id: this.props.route.params.story.story_id,
      is_liked: this.props.route.params.story.is_liked,
    };
  }
  ...
  async initiateTTS(title, author, story, moral) {
   ...
   likeAction=()=>{
     console.log("likeaction&&&&&&&&&&&"+this.props.route.params.story_id)
...
{
console.log("storyscreen"+this.props.route.params.story_id)
